	...
	<div class="main-banner" id="top">
		...
		<div class="container-fluid">
			<ul class="nav justify-content-center">
				<li class="nav-item"><a class="nav-link text-dark" href="#men">Men's</a>
				</li>
				<li class="nav-item"><a class="nav-link text-dark" href="#women">Women's</a>
				</li>
				<li class="nav-item"><a class="nav-link text-dark" href="#kids">Kid's</a>
				</li>
			</ul>
		</div>  
		-->
				...
				<div class="col-lg-6">
					<div class="left-content">
						<div class="thumb">
							...
							<img
								src="<c:url value='/templates/user/images/left-banner-image.jpg'/>"
								alt="">
						</div>
					</div>
				</div>
							...
							<div class="col-lg-6">
								<div class="right-first-image">
									<div class="thumb">
										...
										<img
											src="<c:url value='templates/user/images/baner-right-image-01.jpg' />">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="right-first-image">
									<div class="thumb">
										...
										<img
											src="<c:url value='templates/user/images/baner-right-image-02.jpg' />">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="right-first-image">
									<div class="thumb">
										...
										<img
											src="<c:url value='templates/user/images/baner-right-image-03.jpg' />">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="right-first-image">
									<div class="thumb">
										...
										<img
											src="<c:url value='templates/user/images/baner-right-image-04.jpg' />">
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="men-item-carousel">
						...
						<c:forEach items="${menproducts}" var="men" varStatus="status" begin="0" end="5">
							<div class="item">
								<div class="thumb">
									<div class="hover-content">
										<ul>
										...
										<li><a href="/single-product/${men.productID}"><i
												class="fa fa-shopping-cart"></i></a></li>
									</ul>
									</div>
									<img src="<c:url value='${men.image}' />"
										alt="">
								</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="women-item-carousel">
						...
						<c:forEach items="${womenproducts}" var="women" varStatus="status" begin="0" end="5">
							<div class="item">
								<div class="thumb">
									<div class="hover-content">
										<ul>
										<li><a href="single-product"><i class="fa fa-eye"></i></a></li>
										<li><a href="single-product"><i class="fa fa-star"></i></a></li>
										<li><a href="/single-product/${women.productID}"><i
												class="fa fa-shopping-cart"></i></a></li>
									</ul>
									</div>
									<img src="<c:url value='${women.image}' />"
										alt="">
								</div>
								<div class="down-content">
									<h4>${women.name}</h4>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="kid-item-carousel">
						...
						<c:forEach items="${kidproducts}" var="kid" varStatus="status" begin="0" end="5">
							<div class="item">
								<div class="thumb">
									<div class="hover-content">
										<ul>
										<li><a href="single-product"><i class="fa fa-eye"></i></a></li>
										<li><a href="single-product"><i class="fa fa-star"></i></a></li>
										<li><a href="/single-product/${kid.productID}"><i
												class="fa fa-shopping-cart"></i></a></li>
									</ul>
									</div>
									<img src="<c:url value='${kid.image}' />"
										alt="">
								</div>
								<div class="down-content">
									<h4>${kid.name}</h4>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="first-image">
									<img
										src="<c:url value='templates/user/images/explore-image-01.jpg' />"
										alt="">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="second-image">
									<img
										src="<c:url value='templates/user/images/explore-image-02.jpg' />"
										alt="">
								</div>
							</div>
							<div class="col-lg-6">
			...
			<div class="row images">
				...
				<div class="col-2">
					<div class="thumb">
						...
						<img
							src="<c:url value='templates/user/images/instagram-02.jpg' />"
							alt="">
					</div>
				</div>
				<div class="col-2">
					<div class="thumb">
						...
						<img
							src="<c:url value='templates/user/images/instagram-03.jpg' />"
							alt="">
					</div>
				</div>
				<div class="col-2">
					<div class="thumb">
						...
						<img
							src="<c:url value='templates/user/images/instagram-04.jpg' />"
							alt="">
					</div>
				</div>
				<div class="col-2">
					<div class="thumb">
						...
						<img
							src="<c:url value='templates/user/images/instagram-05.jpg' />"
							alt="">
					</div>
				</div>
				<div class="col-2">
					<div class="thumb">
						...
						<img
							src="<c:url value='templates/user/images/instagram-06.jpg' />"
							alt="">
					</div>
				</div>
			</div>
